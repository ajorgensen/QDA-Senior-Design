...
public class CheckboxTree extends JTree {
     ...
     * causes it to be selected. We had to work around it (see
     * initialize() and processMouseEvent()).
     */
    ...
    /**
     * @return the paths that are in the checking set and are the
	...
	setCheckingModel(new DefaultTreeCheckingModel(this));
	setCellRenderer(new DefaultCheckboxTreeCellRenderer());
	/*
	 * the next line (commented out) is actually the Swing way, but
     ...
     * 
     * @param selectsByChecking the intended behavior of checking with respect to
     *        selection.
     */
