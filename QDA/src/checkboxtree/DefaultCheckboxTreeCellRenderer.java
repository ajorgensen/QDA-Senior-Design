...
import checkboxtree.QuadristateButtonModel.State;
 ...
 * Note that double-clicking the label/icon of this renderer does not toggle the
 * checkbox.
 * 
 * @author boldrini
 * @author bigagli
...
public class DefaultCheckboxTreeCellRenderer extends JPanel implements CheckboxTreeCellRenderer {
	...
	// the commented line was used before 3.1, but the alternative should be
	// preferable
