...
public class DefaultTreeCheckingModel implements TreeCheckingModel {
     ...
     */
    public DefaultTreeCheckingModel(CheckboxTree tree) {
	final CheckboxTree f = tree;
    ...
    /*
     * I'm commenting out this out, since the TreeModel should be a write-only field for this class.
     */
